...
if (pid == 0):  # Child
    ...
    # returns to its parent a pair(base, quality) via pipech2pand writes the pair to an ASCII text file calledworst.txt.  
    # This file iscreated by the child process at the beginning with permissions: rw-rw-r--.
